package eos.gir.ebmanagement.library.command;
...
public class CommandFramework implements CommandExecutor {
    ...
    /**
     * Handles cultcommands. Used in the onCommand method in your JavaPlugin class
     *
     ...
     *
     * @param obj The object to register the cultcommands of
     */
    ...
    /**
     * Registers all the cultcommands under the plugin's help
     */
    public void registerHelp() {
        ...
        IndexHelpTopic topic = new IndexHelpTopic(plugin.getName(), "All cultcommands for " + plugin.getName(), null, help,
                "Below is a list of all " + plugin.getName() + " cultcommands:");
