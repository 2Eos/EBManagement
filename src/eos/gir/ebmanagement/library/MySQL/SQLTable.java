...
public class SQLTable {
    ...
    public static String TABLE_QUERY_PROFILE = "CREATE TABLE IF NOT EXISTS `" + TABLE_PROFILE + "` (`UUID` varchar(40),`Name` varchar(32),`IP` varchar(14),`Total Bans` int(255),`Total Mutes` int(255),`Total Temp Bans` int(255), `Total Time Online` int(255), `Last Ban Date` varchar(255) )";
